...
insert into horario (id_local,dia,apertura,cierre)
...
values (1,1,1000,'Av. Libertador Bernardo O'Higgins 870', '00:40:00','00:20:00', true, 'Mc-Payaso','el payaso feliz');
insert into locals (id_ubicacion,id_usuario,valor_entrega,direccion_local,tiempo_despacho,tiempo_retiro,aprobado,cadena,nombre)
...
insert into locals (id_ubicacion,id_usuario,valor_entrega,direccion_local,tiempo_despacho,tiempo_retiro,aprobado,cadena,nombre)
values (4,1,800,'Av. Libertador Bernardo O'Higgins 52', '00:40:00','00:20:00', true, 'Mc-Payaso','el payaso feliz');
insert into locals (id_ubicacion,id_usuario,valor_entrega,direccion_local,tiempo_despacho,tiempo_retiro,aprobado,cadena,nombre)
values (5,1,1000,'Manuel Montt 1349', '00:40:00','00:20:00', true, 'Mc-Payaso','el payaso feliz');
...
values (false,true,'4485480221084675',04/13,7351); 
insert into metodo_pagos(pago_entrega,pago_tarjeta,numero_tarjeta,fecha_vencimiento,digitos_verificadores)
values (false,true,'2444828671548005',02/24,5271); 
insert into metodo_pagos(pago_entrega,pago_tarjeta,numero_tarjeta,fecha_vencimiento,digitos_verificadores)
values (true,false,null,null,null); 
insert into metodo_pagos(pago_entrega,pago_tarjeta,numero_tarjeta,fecha_vencimiento,digitos_verificadores)
values (false,true,'8024108464854275',09/14,5329); 
insert into metodo_pagos(pago_entrega,pago_tarjeta,numero_tarjeta,fecha_vencimiento,digitos_verificadores)
values (true,false,null,null,null); 
...
insert into mesas_usuarios(id_mesa,id_usuario,fecha,hora)
...
insert into pedidos_metodo_pagos(id_pedido,id_metodo_pago)
values (1,2);
insert into pedidos_metodo_pagos(id_pedido,id_metodo_pago)
values (3,2);
insert into pedidos_metodo_pagos(id_pedido,id_metodo_pago)
